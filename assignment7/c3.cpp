/*
	...
	Method Used: Parallel using OpenMp
*/
...
int main(){
    ...
    #pragma omp parallel private(i, j, k) shared(arr2, arr3, arr1, vec, ans)
	{
    #pragma omp 
    ...
    printf("\nTime taken to multiply using OpenMp (parallel)  :%.6f Seconds\n",time_spent);
