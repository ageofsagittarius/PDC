/*
    ...
    Implemented using OpenMP + MPI:
        To run this open the terminal where the file is stored
        Then write the command mpic++ -fopenmp omp.cpp
...
int main() {
    ...
    // when master thread is the thread
    if(pid == 0){
...
/*
    Sample Input/Output:
    Enter the value of N: 1038492
    The value of PI by calculation is: 3.141351
