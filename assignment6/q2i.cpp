...
/*
     In this part, we were asked to use parallel threads using OpenMP. i used the parallel num_threads 
     method and created 5 threads, each thread computing 200 elements and added the result to parallelSum variable
*/
